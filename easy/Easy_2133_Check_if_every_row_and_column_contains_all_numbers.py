def check_valid(matrix):
    len_m = len(matrix)
    for row in matrix:
        if len(set(row)) != len_m:
            return False
    for col in range(len_m):
        if len(set(matrix[row][col] for row in range(len_m))) != len_m:
            return False
    return True


matrix = [[1, 2, 3], [3, 1, 2], [2, 3, 1]]
matrix_2 = [[1, 1, 1], [1, 2, 3], [1, 2, 3]]
matrix_3 = [[15, 7, 18, 11, 19, 10, 14, 16, 8, 2, 3, 6, 5, 1, 17, 12, 9, 4, 13],
...
print(check_valid(matrix))  # True
print(check_valid(matrix_2))  # False
print(check_valid(matrix_3))  # False
